...
urlpatterns = [
    ...
    path("<uuid:payment_id>/cancel/", cancel_payment, name="cancel-payment"),
    path("<uuid:payment_id>/retry/", retry_payment, name="retry-payment"),
    ...
    path("<uuid:payment_id>/refund/", create_refund, name="create-refund"),
